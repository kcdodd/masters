function [solution] = arcrmodel_radial_2011_5(Te_r_in, ne_r_in, r_in, xn0, T0, ion_fraction, rmin, rmax, numdivs, rates)
...
dndt_exc = zeros(2, numdivs+1, Nuse);
