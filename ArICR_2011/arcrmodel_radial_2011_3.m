function [solution] = arcrmodel_radial_2011_3(Te_r_in, ne_r_in, r_in, xn0, T0, ion_fraction, rmin, rmax, numdivs)
...
solution = struct('population', npop_tot, 'velocity', vr, 'npop', npop, 'dndt', dndt, 'Te', Te_r, 'ne', ne_r, 'r', r_divs, 'ion_fraction', ion_fraction, 'rmin', rmin, 'rmax', rmax, 'numdivs', numdivs, 'Nuse', Nuse, 'useIonRecomb', useIonRecomb,'useRadDecay', useRadDecay, 'useThermal', useThermal, 'useMeta', useMeta);
