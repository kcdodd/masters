...
solution = struct('density', ntot, 'population', npop_tot, 'velocity', vr, 'npop', npop, 'dndt', dndt, 'static', static, 'Te', Te_r, 'ne', ne_r, 'r', r_divs, 'ion_fraction', ion_fraction, 'rmin', rmin, 'rmax', rmax, 'numdivs', numdivs, 'dt', dt, 'Nuse', Nuse, 'useIonRecomb', useIonRecomb,'useRadDecay', useRadDecay, 'useThermal', useThermal, 'useMeta', useMeta);
