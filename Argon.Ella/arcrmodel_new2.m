function [xn0,ArI_pop,ArI_Gain, ArI_Loss] = arcrmodel_new2(ne_Te_filename,factor, Nediv, xrad)
%==========================================================
...
for n = 1:Ntot
    ...
    for iEe = 1:NE+1
        ...
        rrec2e(n)=rrec2e(n) + fe(iEe) * Srec2e(Ee(iEe),n,Eion(n),g(n),gi(n)) * nes * fac(n) * ni;
...
for n = 2:Nuse
    ...
    for m = n+1:Nuse
        ...
        Kloss(n)=Kloss(n) + kexce(n,m) + useExt*(kexci(n,m) + kexca(n,m) + kexcth(n,m));
        losses(n, m) = kexce(n,m) + useExt*(kexci(n,m) + kexca(n,m) + kexcth(n,m));
    ...
    for l = 1:n-1
        ...
        losses(n, l) = Arad + kdeexe(n,l) + useExt*(kdeexi(n,l) + kdeexa(n,l) + kdeexth(n,l));
        
        Kloss(n)=Kloss(n) + kdeexe(n,l) + useExt*(kdeexi(n,l) + kdeexa(n,l) + kdeexth(n,l)) + Arad;
        
    end
    
    % electron, ion, fast atom, therm.atom ionization
    %- - - - - - - - - - - - - - - - - - - - - - - - - 
    Kloss(n)=Kloss(n) + useExt*(kione(n) + kioni(n) + kiona(n) + kionth(n));
    
    losses(n, Nuse+1) = kione(n) + kioni(n) + kiona(n) + kionth(n);
end
...
for it = 1:10000000
    ...
    for n = 2:2:4
        ...
        %..............................
        for l = 1:n-1
            prod=prod + (kexce(l,n) + useExt*(kexci(l,n) + kexca(l,n) + kexcth(l,n))) * pop(l);
            ArI_Gain(n, l) = (kexce(l,n) + useExt*(kexci(l,n) + kexca(l,n) + kexcth(l,n))) * pop(l);
        ...
        %............................................
        for m=n+1:Nuse
            prod=prod + (kdeexe(m,n) + useExt*(kdeexi(m,n) + kdeexa(m,n) + kdeexth(m,n)) + A(n,m))*pop(m);
            ArI_Gain(n, m) = (kdeexe(m,n) + useExt*(kdeexi(m,n) + kdeexa(m,n) + kdeexth(m,n)) + A(n,m))*pop(m);
        ...
        %.............................
        prod=prod + useExt*(rrec1e(n) + rrec2e(n) + rreci(n) + rreca(n) + rrecth(n));
        
        ArI_Gain(n, Nuse+1) = useExt*(rrec1e(n) + rrec2e(n) + rreci(n) + rreca(n) + rrecth(n));
