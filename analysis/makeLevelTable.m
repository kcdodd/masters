...
%ArII_frac = [1, 1, 0.973, 0.213, 0.011, 0.000001];
%ArII_frac = [1, 1, 1, 0.75, 0.5, 0.25];
ArII_frac = [1, 1, 1, 1, 1, 1];
...
for i=1:size(Te_l,2)
    npop{1,1}(i,:) = npop{1,1}(i,:).*ne_l*ArII_frac(i);
    npop{2,1}(i,:) = npop{2,1}(i,:).*ne_l*ArII_frac(i);
    npop{3,1}(i,:) = npop{3,1}(i,:).*ne_l*ArII_frac(i);
end
